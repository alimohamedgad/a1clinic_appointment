          ...
          children: <Widget>[
            ...
            Obx(() {
              if (controller.isDone()) {
                ...
                return Text(
                  "Please wait Loading payment information".tr,
                  style: context.textTheme.titleLarge,
                );
              }else if (controller.isFailed()) {
                return Text(
            ...
            Opacity(
              ...
              child: Obx(() {
                if (controller.isDone()) {
                  return Text(
                    "Your payment is pending confirmation from the Doctor".tr,
                    textAlign: TextAlign.center,
                    style: Get.textTheme.headlineMedium,
                  );
                } else if (controller.isLoading()) {
                  return Text(
                    "Thank you for your understanding".tr,
                    textAlign: TextAlign.center,
                    style: Get.textTheme.headlineMedium,
                  );
                } else if (controller.isFailed()) {
