              ...
              SliverToBoxAdapter(
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text("These are all the patients assigned to your account you can create ne ones using the add button below".tr, style: Get.textTheme.bodyMedium).paddingSymmetric(horizontal: 22, vertical: 5,),
                    PatientsListWidget(),
                  ],
                ),
              ),
