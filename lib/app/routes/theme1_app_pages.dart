...
import '../modules/checkout/controllers/urway_controller.dart';
import '../modules/checkout/views/rejection_view.dart';
import '../modules/checkout/views/urway_view.dart';
import '../modules/contact_us/bindings/contact_us_binding.dart';
import '../modules/contact_us/views/contact_us_view.dart';
import '../modules/maps/bindings/maps_binding.dart';
import '../modules/maps/views/maps_view.dart';
import '../modules/maps/widgets/web_view_google_maps.dart';
...
import '../modules/procedure_guide/bindings/procedure_guide_binding.dart';
import '../modules/procedure_guide/views/procedure_guide_view.dart';
import '../modules/procedure_guide/views/procedure_guides_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.PROCEDURE_GUIDE, page: () => ProcedureGuideView(), binding: ProcedureGuideBinding()),
    GetPage(name: Routes.PROCEDURE_GUIDES, page: () => ProcedureGuidesView(), binding: ProcedureGuideBinding()),
    ...
    GetPage(name: Routes.Google_Maps, page: () => WebViewGoogleMaps(), binding: MapsBinding()),
    ...
    GetPage(name: Routes.REJECTION, page: () => RejectionView(), binding: CheckoutBinding(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: Routes.MADA, page: () => UrWayViewWidget(), binding: CheckoutBinding(), middlewares: [AuthMiddleware()]),
